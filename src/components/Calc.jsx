    ...
    return (
        <form>
            ...
            <div className="grid grid-cols-4 gap-5 px-5">
                ...
                <input className='function' type="button" value="DL" onClick={() => setValue(value.slice(0, -1))} />
                <input className='function' type="button" value="%" onClick={e => { if (!value.includes('%')) { setValue(value + e.target.value) } }} />
                <input className='oprator' type="button" value="/" onClick={e => { if (!value.includes('/')) { setValue(value + e.target.value) } }} />
                ...
                <input className='number' type="button" value="." onClick={e => { if (!value.includes('.')) { setValue(value + e.target.value) } }} />
